...
public class Graph implements GLEventListener, GraphSettings {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        String vertexShaderSourcePoints = "#version 400 core\n" +
                "in vec2 position;\n" +
                "in float size;\n" +
                "in vec3 color;\n" +
        ...
        String fragmentShaderSourcePoints = "#version 400 core\n" +
                "in vec3 fragColor;\n" +
                "out vec4 color;\n" +
                "void main() {\n" +
        ...
        String vertexShaderSourceEdges = "#version 400 core\n" +
                "in vec2 position;\n" +
                "in vec3 color;\n" +
                "uniform mat4 u_transform;\n" +
                "out vec3 fragColor;\n" +
        ...
        String fragmentShaderSourceEdges = "#version 400 core\n" +
                "in vec3 fragColor;\n" +
                "out vec4 color;\n" +
                "void main() {\n" +
                "   color = vec4(fragColor, 1.0);\n" +
